...
function start(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 40) {
            qm.sendOk(
                "I understand that you feel trepidations about helping out a strange town like Zipangu. I am the one that is unaffected by #bThe Spell of Acacia#k, which means I will have to risk my life to save this town from total destruction."
            );
            qm.dispose();
            return;
        }
    ...
    switch (status) {
        case 0:
            if (qm.getQuestCustomData() != null) {
                // if (qm.getQuestCustomData().equals("readHistory")) {
                qm.sendSimple(
                    "Good to see you back, Mapler. How did you fare against the goblin? #b \n\r #L0#I was able to defeat the monster of Ninja Castle!#l \n\r #L1#No, I wasn't able to.#l"
                );
                status = 99;
            } else {
                qm.sendNext(
                    "My name is #p9120025#, and I am the protector of Zipangu at \n#m802000101#."
                );
            }
            break;
        case 1:
        ...
        case 2:
            qm.sendNextPrev(
                "Oh... I see that you have been making proper strides. \n\n&lt;Grit... you were right...&gt;"
            );
            break;
        case 3:
            qm.sendNextPrev(
                "I remember when you first stepped into Maple Island, looking very green to say the least... and here you are, standing right in front of me looking every bit like a true Mapler. As someone that closely followed your path, I feel... a rush of satisfaction seeing you all grown up.\n\n(#p9120025# begins to well up)"
            );
            break;
        case 4:
            qm.sendNextPrev(
        ...
        case 7:
            qm.sendNextPrev(
                "This land right here is the lowest, most distant land you'll find in #m802000101#."
            );
            break;
        case 8:
        ...
        case 11:
            qm.sendNextPrev(
                "...Yes, Zipangu will one day completely disappear from this world without a trace. I saw it with my own eyes how this ball of #bdistortion#k appeared from the sky and completely swallowed up Zipangu as a whole."
            );
            break;
        case 12:
            qm.sendNextPrev(
        ...
        case 21:
            qm.sendNextPrev(
                "The fact that a supernatural book that chronicles every move of every resident of Zipangu exists... the book that's called #bAcacia Chronicle#k..."
            );
            break;
        case 22:
            qm.sendNextPrev(
        ...
        case 23:
            qm.sendNextPrev(
                "In that world of distortion, I was able to get my hands on \n#bAcacia Chronicle#k, and started reading it."
            );
            break;
        case 24:
        ...
        case 25:
            qm.sendNextPrev(
                "I realized that #bAcacia Chronicle#k did not include informations about me."
            );
            break;
        case 26:
            qm.sendNextPrev(
        ...
        case 27:
            qm.sendNextPrev(
                "It might be that the reason why I was freed from the #bcurse of Acacia Chronicle#k was because I was able to form a close bond with someone outside Zipangu, which in the end led me to achieve #bimmortality#k."
            );
            break;
        case 28:
            qm.sendNextPrev(
                "It also remained to be seen whether #bAcacia Chronicle#k can be subject to change in contents for revised editions."
            );
            break;
        case 29:
            qm.sendNextPrev(
                "So my plan was to return to the past and alter the history myself, so the part where the #bdistortion#k appeared in the book would be destroyed at the last minute, and prevent Zipangu from a certain destruction."
            );
            break;
        case 30:
            qm.sendNextPrev(
                "But in the end, I realized that tampering with the past, even if it meant saving Zipangu, would be a foolish act.\nAltering the past through the book would most certainly wipe out the very existence of all those people that would be born in the future."
            );
            break;
        case 31:
            qm.sendNextPrev(
        ...
        case 33:
            qm.sendNextPrev(
                "Today, I spend my days observing Zipangu which is right on the verge of destruction, with the starting point being #m802000101#."
            );
            break;
        case 34:
        ...
        case 37:
            qm.sendNextPrev(
                "Unfortunately, #bThe Spell of Acacia#k has prevented Zipanguans from directly altering the history themselves."
            );
            break;
        case 38:
        ...
        case 40:
            qm.sendYesNo(
                "I would like for you to help us save Zipangu, the one that is unaffected by #bThe Spell of Acacia#k. Will you?"
            );
            break;
        case 41:
            //	    qm.forceStartQuest();
            ...
            qm.sendNextPrev(
                "Thank you, Mapler... thank you...（#p9120025# breathes a heavy sigh of relief)"
            );
            break;
        case 42:
            qm.sendNextPrev(
                "With the kind of power you possess, I have no doubt in my mind that you are capable of holding your own against the powerful foes from era."
            );
            break;
        case 43:
            qm.sendNextPrev(
                "That being said... I want to see the extent of your power with my very own eyes."
            );
            break;
        case 44:
            qm.sendNextPrev(
                "I had been in search of someone that possessed immense talent and power for the past few thousand years.\nThe era where Zipangu is on the verge of destruction is a scientifically-advanced era where the monsters you'll face against are beyond your wildest imagination."
            );
            break;
        case 45:
            qm.sendNextPrev(
        ...
        case 52:
            qm.sendNextPrev(
                "I also realized that the goblin, which had reigned supreme for 10 years, does not affect the course of the future of Zipangu if defeated by an individual that is unaffected by \n#bThe Spell of Acacia#k."
            );
            break;
        case 53:
            qm.sendNextPrev(
                "I prepared the Worm Hole at Mushroom Shrine, which will allow one to travel to the past, and brought residents of the Maple World to the Ninja Castle to test out their strength and see whether they were strong enough to battle the monsters from the future."
            );
            break;
        case 54:
            qm.sendNextPrev(
        ...
        case 56:
            qm.sendNext(
                "Please defeat the Ninja Goblin at the Ninja Castle and bring back the following items as proof: #b300 #t04000340#s, 1 #t04000342#, and 1 #t04000343#."
            );
            qm.dispose();
            break;
        case 100:
            if (selection == 0) {
                if (
                    qm.haveItem(4000343, 1) &&
                    qm.haveItem(4000340, 300) &&
                    qm.haveItem(4000342, 1)
                ) {
                    status = 119;
                    qm.sendNextPrev("Brilliant.");
                } else {
                    qm.sendNext(
                        "This isn't enough for me to gauge the extent of your power. I want you to defeat more monsters inside the castle and bring sufficient amount of evidence, okay?"
                    );
                    qm.dispose();
                }
            } else {
                if (qm.haveItem(5252002, 1)) {
                    ...
                    status = 109;
                    qm.sendNext(
                        "If you do not have evidence that you have defeated the goblin at the castle, then I can't send you to the future. The future is full of monsters that far exceeds that of the goblin."
                    );
                }
            }
            break;
        case 110:
            qm.sendNextPrev(
                "Please defeat the goblin at Ninja Castle and bring me an evidence."
            );
            break;
        case 111:
            qm.sendPrev(
                "I hear stories that you may buy your evidence at a place called Cash Shop... but if you are good at combat, then you really don't need to spend money on stuff like that. I already feel the wave of restoration hitting this place. I'll now leave it up to you."
            );
            qm.dispose();
            break;
        case 120:
        ...
        case 121:
            qm.sendNextPrev(
                "I will now hand you a #bLv 1 Gate Pass#k. It's an evidence that you're from #m802000101#, and the pass is required for you to enter the future of Zipangu. Please do not lose this pass."
            );
            break;
        case 122:
            qm.sendNextPrev(
                "This will not enable you to open the door to Zipangu's future, and take part in altering the history of this great town."
            );
            break;
        case 123:
            qm.sendNextPrev(
