...
function start() {
    if (cm.haveItem(4031508, 5) && cm.haveItem(4031507, 5)) {
        cm.sendNext(
            "Wow ~ Voc� conseguiu coletar 5 de cada #b#t4031508##k e #b#t4031507##k. Ok ent�o, eu vou mandar voce para o Zoo. Por favor, fale comigo de novo quando voc� chegar l�."
        );
    } else {
        cm.sendYesNo(
