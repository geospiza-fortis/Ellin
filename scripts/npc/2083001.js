    ...
    if (mode == -1) {
        ...
        if (isRecruitingMap(cm.getMapId())) {
            if (status == 0) {
                ...
                cm.sendSimple(
                    "#e#b<Party Quest: Horntail Trial Grounds>\r\n#k#n" +
                ...
                if (selection == 0) {
                    if (cm.getParty() == null) {
                        ...
                        if (eli.size() > 0) {
                            ...
                            cm.sendOk(
                                "Either I cannot accept some members of your party inside the cave or you team is lacking. Solve this problem then talk to me!"
                            );
                        }
            ...
            if (!cm.isEventLeader()) {
                cm.sendOk(
                    "Only your event leader is allowed to interact with the Schedule."
                );
                ...
                if (cm.haveItem(4001092, 1) && cm.haveItem(4001093, 6)) {
                    ...
                    cm.sendOk(
                        "Check if you have got all 6 Red keys and 1 Blue key with you."
                    );
                }
