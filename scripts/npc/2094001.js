    ...
    if (mode == -1) {
        ...
        if (cm.getMapId() == 925100500) {
            if (status == 0) {
                if (cm.isEventLeader()) {
                    cm.sendOk(
                        "I have been saved thanks to your efforts! Thank you, guys!"
                    );
                } else {
                    cm.sendOk(
                        "I have been saved thanks to your efforts! Thank you, guys! Let your party leader talk to me first before I give you your rewards..."
                    );
                    cm.dispose();
                }
            } else {
                    ...
                    if (cm.haveItem(1003267, 1)) {
                        ...
                        if (cm.haveItem(4001158, 20)) {
                            if (cm.canHold(1003267, 1)) {
                                ...
                                cm.sendOk(
                                    "Please make room in your EQUIP inventory before receiving the hat."
                                );
                            }
                        } else {
                            cm.sendOk(
                                "You need 20 #t4001158# to get the next hat."
                            );
                        }
