...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            cm.sendYesNo(
                "If you use the regular coupon, you'll be awarded a random pair of cosmetic lenses. Are you going to use a #b#t5152039##k and really make the change to your eyes?"
            );
        } else if (selection == 2) {
            beauty = 2;
            if (cm.getPlayer().getGender() == 0) {
