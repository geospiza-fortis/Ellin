...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            cm.sendSimple(
                "I'm Salon Seamus. If you have #b#t5150019##k or #b#t5151016##k by any chance, then how about letting me change your hairdo?\r\n#L0##i5150019##t5150019##l\r\n#L1##i5151016##t5151016##l"
            );
        } else if (status == 1) {
            if (selection == 0) {
                beauty = 1;
                ...
                cm.sendYesNo(
                    "If you use the EXP coupon your hair will change RANDOMLY with a chance to obtain a new experimental style that even you didn't think was possible. Are you going to use #b#t5150019##k and really change your hairstyle?"
                );
            } else if (selection == 1) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendYesNo(
                    "If you use a regular coupon your hair will change RANDOMLY. Do you still want to use #b#t5150019##k and change it up?"
                );
            }
        } else if (status == 2) {
            if (beauty == 1) {
