...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            cm.sendSimple(
                "#e#b<Party Quest: Ludibrium Maze>\r\n#k#n" +
            ...
            if (selection == 0) {
                if (cm.getParty() == null) {
                    ...
                    cm.sendOk(
                        "If you DO decide to tackle it, please have your Party Leader notify me!"
                    );
                    cm.dispose();
                } else {
                    ...
                    if (eli.size() > 0) {
                        ...
                        cm.sendOk(
                            "Your party needs to consist of at least 3 members in order to tackle this maze."
                        );
                    }
