...
public class FieldBoss {
    ...
    public enum FieldBosses {
        ...
        STUMPY(
            ...
            new Point(810, 1570),
            new Point(838, 2197),
            "Stumpy apareceu com um som que toca a Stone Mountain."
        ),
        KING_CLANG(
            5220001,
            1200,
        ...
        TAE_ROON(
            ...
            new Point(-234, 393),
            new Point(-654, 33),
            "Tae Roon appeared with a loud growl."
        ),
        ELIZA(
            8220000,
            1200,
        ...
        GHOST_PRIEST(
            ...
            new Point(227, 543),
            new Point(719, 543),
            "The area fills with an unpleasant force of evil.. even the occasional ones of the cats sound disturbing"
        ),
        OLD_FOX(
            7220001,
            2700,
        ...
        DALE(
            ...
            new Point(95, 119),
            new Point(-535, 120),
            "The huge crocodile Dale has come out from the swamp."
        ),
        FAUST(
            5220002,
            1800,
            ...
            new Point(557, 278),
            new Point(95, 278),
            "The blue fog became darker when Faust appeared."
        ),
        TIMER(
            5220003,
            1500,
            ...
            new Point(532, 1032),
            new Point(-47, 1032),
            "Click clock! Timer has appeared with an irregular clock sound."
        ),
        JENO(
            6220001,
            2400,
            ...
            new Point(-4283, 776),
            new Point(-3292, 776),
            "Jeno has appeared with a heavy sound of machinery."
        ),
        LEV(
            8220003,
            7200,
            ...
            new Point(127, 1634),
            new Point(159, 1142),
            "Leviathan has appeared with a cold wind from over the gorge."
        ),
        DEWU(
            3220001,
            3600,
            ...
            new Point(298, 275),
            new Point(592, 275),
            "Dewu slowly appeared out of the sand dust."
        ),
        CHIMERA(
            8220002,
            2700,
            ...
            new Point(-772, -116),
            new Point(-108, 181),
            "Chimera has appeared out of the darkness of the underground with a glitter in her eyes."
        ),
        SHERP(
            4220000,
            2700,
            ...
            new Point(-272, -500),
            new Point(-462, 640),
            "A strange shell has appeared from a grove of seaweed."
        );
    ...
    public static void RegisterBossRespawn(final Field map) {
        ...
        if (fb != null) {
            map.addAreaMonsterSpawn(
                MapleLifeFactory.getMonster(fb.getBoss()),
                fb.getPositionOne(),
                fb.getPositionTwo(),
                fb.getPositionThree(),
                fb.getTimeMob(),
