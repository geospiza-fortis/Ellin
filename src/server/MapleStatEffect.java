...
public class MapleStatEffect implements Serializable {
    ...
    private static void addBuffStatPairToListIfNotZero(
        List<Pair<BuffStat, Integer>> list,
        BuffStat buffstat,
        Integer val
    ) {
        if (val != 0) {
    ...
    private static MapleStatEffect loadFromData(
        ...
        ret.bulletConsume =
            MapleDataTool.getIntConvert("bulletConsume", source, 0);
        ...
        ret.consumeOnPickup =
            MapleDataTool.getInt("consumeOnPickup", source, 0) > 0;
        ...
        if (skill) {
            switch (sourceid) {
                case Beginner.Recovery:
                    statups.add(
                        new Pair<>(BuffStat.RECOVERY, Integer.valueOf(x))
                    );
                    break;
                case Magician.MagicGuard:
                    statups.add(
                        new Pair<>(BuffStat.MAGIC_GUARD, Integer.valueOf(x))
                    );
                    break;
                case Cleric.Invincible:
                    statups.add(
                        new Pair<>(BuffStat.INVINCIBLE, Integer.valueOf(x))
                    );
                    break;
                case SuperGm.Hide:
                ...
                case Rogue.DarkSight:
                    statups.add(
                        new Pair<>(BuffStat.DARKSIGHT, Integer.valueOf(x))
                    );
                    break;
                case ChiefBandit.Pickpocket:
                    statups.add(
                        new Pair<>(BuffStat.PICKPOCKET, Integer.valueOf(x))
                    );
                    break;
                case ChiefBandit.MesoGuard:
                    statups.add(
                        new Pair<>(BuffStat.MESOGUARD, Integer.valueOf(x))
                    );
                    break;
                case Hermit.MesoUp:
                    statups.add(
                        new Pair<>(BuffStat.MESOUP, Integer.valueOf(x))
                    );
                    break;
                case Hermit.ShadowPartner:
                    statups.add(
                        new Pair<>(BuffStat.SHADOWPARTNER, Integer.valueOf(x))
                    );
                    break;
                ...
                case Priest.MysticDoor:
                    statups.add(
                        new Pair<>(BuffStat.SOULARROW, Integer.valueOf(x))
                    );
                    break;
                ...
                case Paladin.BwHolyCharge:
                    statups.add(
                        new Pair<>(BuffStat.WK_CHARGE, Integer.valueOf(x))
                    );
                    break;
                ...
                case Gunslinger.GunBooster:
                    statups.add(
                        new Pair<>(BuffStat.BOOSTER, Integer.valueOf(x))
                    );
                    break;
                case Buccaneer.SpeedInfusion:
                case Corsair.HerosWill:
                    statups.add(
                        new Pair<>(BuffStat.SPEED_INFUSION, Integer.valueOf(-4))
                    );
                    break;
                case Fighter.Rage:
                    statups.add(
                        new Pair<>(BuffStat.WDEF, Integer.valueOf(ret.wdef))
                    );
                case Hero.Enrage:
                    statups.add(
                        new Pair<>(BuffStat.WATK, Integer.valueOf(ret.watk))
                    );
                    break;
                case SpearMan.IronWill:
                    statups.add(
                        new Pair<>(BuffStat.MDEF, Integer.valueOf(ret.mdef))
                    );
                ...
                case ILWizard.Meditation:
                    statups.add(
                        new Pair<>(BuffStat.MATK, Integer.valueOf(ret.matk))
                    );
                    break;
                case Assassin.Haste:
                case Bandit.Haste:
                case SuperGm.Haste:
                    statups.add(
                        new Pair<>(BuffStat.SPEED, Integer.valueOf(ret.speed))
                    );
                    statups.add(
                        new Pair<>(BuffStat.JUMP, Integer.valueOf(ret.jump))
                    );
                    break;
                case Cleric.Bless:
                    statups.add(
                ...
                case Archer.Focus:
                    statups.add(
                        new Pair<>(BuffStat.ACC, Integer.valueOf(ret.acc))
                    );
                    statups.add(
                        new Pair<>(BuffStat.AVOID, Integer.valueOf(ret.avoid))
                    );
                    break;
                case SuperGm.Bless:
                    statups.add(
                ...
                case Page.PowerGuard:
                    statups.add(
                        new Pair<>(BuffStat.POWERGUARD, Integer.valueOf(x))
                    );
                    break;
                case SpearMan.HyperBody:
                case SuperGm.HyperBody:
                    statups.add(
                        new Pair<>(BuffStat.HYPERBODYHP, Integer.valueOf(x))
                    );
                    statups.add(
                        new Pair<>(BuffStat.HYPERBODYMP, Integer.valueOf(ret.y))
                    );
                    break;
                ...
                case Beginner.MonsterRider:
                    statups.add(
                        new Pair<>(BuffStat.MONSTER_RIDING, Integer.valueOf(1))
                    );
                    break;
                case 5221006: // 4th Job - Pirate riding
                    statups.add(
                        new Pair<BuffStat, Integer>(
                ...
                case DragonKnight.DragonBlood:
                    statups.add(
                        new Pair<>(BuffStat.DRAGONBLOOD, Integer.valueOf(ret.x))
                    );
                    break;
                ...
                case Corsair.WrathOfTheOctopi:
                    statups.add(
                        new Pair<>(BuffStat.SUMMON, Integer.valueOf(1))
                    );
                    break;
                case Priest.HolySymbol:
                case SuperGm.HolySymbol:
                    statups.add(
                        new Pair<>(BuffStat.HOLY_SYMBOL, Integer.valueOf(x))
                    );
                    break;
                case NightLord.ShadowStars:
                    statups.add(
                        new Pair<>(BuffStat.SHADOW_CLAW, Integer.valueOf(0))
                    );
                    break;
                ...
                case Bishop.Infinity:
                    statups.add(
                        new Pair<>(BuffStat.INFINITY, Integer.valueOf(x))
                    );
                    break;
                ...
                case DarkKnight.PowerStance:
                    statups.add(
                        new Pair<>(BuffStat.STANCE, Integer.valueOf(iprop))
                    );
                    break;
                case Beginner.EchoOfHero:
                    statups.add(
                        new Pair<>(
                            BuffStat.ECHO_OF_HERO,
                            Integer.valueOf(ret.x)
                        )
                    );
                    break;
                ...
                case Bishop.ManaReflection:
                    statups.add(
                        new Pair<>(BuffStat.MANA_REFLECTION, Integer.valueOf(1))
                    );
                    break;
                case Bishop.HolyShield:
                    statups.add(
                        new Pair<>(BuffStat.HOLY_SHIELD, Integer.valueOf(x))
                    );
                    break;
                case Ranger.Puppet:
                case Sniper.Puppet:
                    statups.add(
                        new Pair<>(BuffStat.PUPPET, Integer.valueOf(1))
                    );
                    break;
                ...
                case Hermit.ShadowWeb:
                    monsterStatus.put(
                        MonsterStatus.SHADOW_WEB,
                        Integer.valueOf(1)
                    );
                    break;
                case Bowmaster.Hamstring:
                    statups.add(
                        new Pair<>(BuffStat.HAMSTRING, Integer.valueOf(x))
                    );
        ...
        if (ret.isShield()) {
            statups.add(
                new Pair<>(BuffStat.SHIELD, Integer.valueOf(ret.shield))
            );
        }

        if (ret.isMorph()) {
            statups.add(
                new Pair<>(BuffStat.MORPH, Integer.valueOf(ret.getMorph()))
            );
        }
    ...
    public void applyPassive(Player applyto, FieldObject obj, int attack) {
        if (makeChanceResult()) {
            switch (sourceid) {
                ...
                case Cleric.MpEater:
                    if (
                        obj == null || obj.getType() != FieldObjectType.MONSTER
                    ) {
                        return;
                    }
                    ...
                    if (!mob.isBoss()) {
                        ...
                        if (absorbMp > 0) {
                            ...
                            applyto
                                ...
                                .getSession()
                                .write(
                                    EffectPackets.ShowOwnBuffEffect(sourceid, 1)
                                );
                            applyto
                                .getMap()
                                .broadcastMessage(
    ...
    private boolean applyTo(
        ...
        if (primary) {
            if (itemConNo != 0) {
                ...
                InventoryManipulator.removeById(
                    applyto.getClient(),
                    ItemConstants.getInventoryType(itemCon),
                    itemCon,
                    itemConNo,
                    false,
                    true
            ...
            applyto
                ...
                .broadcastMessage(
                    applyto,
                    PacketCreator.RemovePlayerFromMap(applyto.getId()),
                    false
                );
            applyto
                .getMap()
                .broadcastMessage(
                    applyto,
                    PacketCreator.SpawnPlayerMapObject(applyto),
                    false
                );
            ...
            if (applyto.getChalkboard() != null) {
                applyto
                    ...
                    .broadcastMessage(
                        applyto,
                        (PacketCreator.UseChalkBoard(applyto, false)),
                        false
                    );
            }
        }
        ...
        if (hpChange != 0) {
            ...
            hpmpupdate.add(
                new Pair<>(
                    PlayerStat.HP,
                    Integer.valueOf(applyto.getStat().getHp())
                )
            );
        }
        ...
        if (mpChange != 0) {
            ...
            hpmpupdate.add(
                new Pair<>(
                    PlayerStat.MP,
                    Integer.valueOf(applyto.getStat().getMp())
                )
            );
        }
        ...
        applyto
            .getClient()
            .getSession()
            .write(PacketCreator.UpdatePlayerStats(hpmpupdate, true));
        ...
        if (
            ...
            if (door.getOwnerId() >= 0) {
                if (applyto.getParty() != null) {
                    for (MaplePartyCharacter partyMember : applyto
                        .getParty()
                        .getMembers()) {
                        partyMember
                            .getPlayer()
                            .addDoor(door.getOwnerId(), door);
                ...
                InventoryManipulator.addFromDrop(
                    applyto.getClient(),
                    new Item(4006000, (byte) 0, (short) 1),
                    "",
                    true
                );
                if (door.getOwnerId() == -3) applyto.dropMessage(
                    5,
                    "Mystic Door cannot be cast far from a spawn point. Nearest one is at " +
                    door.getDoorStatus().getRight() +
                    "pts " +
                    door.getDoorStatus().getLeft()
                ); else if (door.getOwnerId() == -2) applyto.dropMessage(
                    5,
                    "Mystic Door cannot be cast on a slope, try elsewhere."
                ); else applyto.dropMessage(
                    5,
    ...
    private void applyBuff(Player applyfrom, boolean useMaxRange) {
        if (applyfrom != null) {
            if (
                isPartyBuff() &&
                (applyfrom.getParty() != null || isGameMasterBuff())
            ) {
                ...
                List<FieldObject> affecteds = applyfrom
                    .getMap()
                    .getMapObjectsInRect(
                        bounds,
                ...
                for (FieldObject affectedmo : affecteds) {
                    ...
                    if (
                        ...
                        int expadd = (int) (
                            ...
                            (
                                ...
                                (applyfrom.getLevel() / 30)
                            )
                        );
                        if (
                            affected.getStat().getHp() <
                            affected.getStat().getMaxHp() -
                            affected.getStat().getMaxHp() /
                            20
                        ) {
                    ...
                    if (affected != null) {
                        if (
                            ...
                            if (
                                (isRessurection && !affected.isAlive()) ||
                                (!isRessurection && affected.isAlive())
                            ) {
                ...
                for (Player affected : affectedp) {
                    ...
                    affected
                        .getClient()
                        .getSession()
                        .write(EffectPackets.ShowOwnBuffEffect(sourceid, 2));
                    affected
                        .getMap()
                        .broadcastMessage(
                            affected,
    ...
    private void applyMonsterBuff(Player applyfrom) {
        ...
        List<FieldObject> affected = applyfrom
            .getMap()
            .getMapObjectsInRect(
                bounds,
    ...
    private final void removeMonsterBuff(final Player applyfrom) {
        ...
        final List<FieldObject> affected = applyfrom
            .getMap()
            .getMapObjectsInRect(
                bounds,
                Arrays.asList(FieldObjectType.MONSTER)
    ...
    public void silentApplyBuff(Player p, long starttime) {
        ...
        p.registerEffect(
            ...
            SkillTimer
                .getInstance()
                .schedule(
                    new CancelEffectAction(p, this, starttime),
        ...
        if (sourceid == Corsair.Battleship) {
            p.announce(
                PacketCreator.SkillCooldown(5221999, p.getCurrentBattleShipHP())
            );
        }
    }
    ...
    private void applyBuffEffect(
        ...
        if (isMonsterRiding()) {
            ...
            if (sourceid == Corsair.Battleship) {
                givemount =
                    new TamingMob(applyto, ridingLevel, Corsair.Battleship);
            } else {
            ...
            localStatups =
                Collections.singletonList(
                    new Pair<>(BuffStat.MONSTER_RIDING, 0)
                );
        }
        ...
        if (localStatups.size() > 0) {
            if (isDash()) {
                if (!applyto.getJob().isA(PlayerJob.PIRATE)) {
                    applyto.changeSkillLevel(
                        PlayerSkillFactory.getSkill(sourceid),
                        0,
                        10
                    );
                } else {
                    localStatups =
                        Collections.singletonList(new Pair<>(BuffStat.DASH, 1));
                    applyto
                        .getClient()
                        .getSession()
                        .write(
                            PacketCreator.GiveDash(
                                localStatups,
                                localX,
                                localY,
                                seconds
                ...
                applyto
                    .getClient()
                    .getSession()
                    .write(PacketCreator.GiveInfusion(seconds, x));
            } else {
                applyto
                    .getClient()
                    .getSession()
        ...
        if (isMonsterRiding()) {
            List<Pair<BuffStat, Integer>> stat = Collections.singletonList(
                new Pair<>(BuffStat.MONSTER_RIDING, 1)
            );
            if (applyto.getMount().getItemId() != 0) {
                applyto
                    ...
                    .broadcastMessage(
                        applyto,
                        PacketCreator.ShowMonsterRiding(
                            applyto.getId(),
                            stat,
                            givemount
                        ),
            ...
            List<Pair<BuffStat, Integer>> dsstat = Collections.singletonList(
            ...
            applyto
                ...
                .broadcastMessage(
                    applyto,
                    PacketCreator.BuffMapEffect(applyto.getId(), dsstat, false),
                    false
                );
        } else if (isCombo()) {
            List<Pair<BuffStat, Integer>> stat = Collections.singletonList(
            ...
            applyto
                ...
                .broadcastMessage(
                    applyto,
                    PacketCreator.BuffMapEffect(applyto.getId(), stat, false),
                    false
                );
        } else if (isShadowPartner()) {
            List<Pair<BuffStat, Integer>> stat = Collections.singletonList(
                new Pair<>(BuffStat.SHADOWPARTNER, 0)
            );
            applyto
                .getMap()
                .broadcastMessage(
            ...
            List<Pair<BuffStat, Integer>> stat = Collections.singletonList(
                new Pair<>(BuffStat.SHIELD, shield)
            );
            applyto
                .getMap()
                .broadcastMessage(
            ...
            applyto
                ...
                .broadcastMessage(
                    applyto,
                    PacketCreator.BuffMapEffect(applyto.getId(), stat, true),
                    false
                );
        } else if (isTimeLeap()) {
            applyto.removeAllCooldownsExcept(Buccaneer.TimeLeap, true);
        ...
        if (localStatups.size() > 0) {
            ...
            ScheduledFuture<?> schedule = SkillTimer
                .getInstance()
        ...
        if (primary) {
            if (isDash()) {
                applyto
                    ...
                    .broadcastMessage(
                        applyto,
                        EffectPackets.ShowDashEffecttoOthers(
                            applyto.getId(),
                            localX,
                            localY,
                            seconds
                ...
                applyto
                    ...
                    .broadcastMessage(
                        applyto,
                        PacketCreator.GiveForeignInfusion(
                            applyto.getId(),
                            x,
                            seconds
                        ),
        ...
        if (sourceid == Corsair.Battleship) {
            applyto.announce(
                PacketCreator.SkillCooldown(
                    5221999,
                    applyto.getCurrentBattleShipHP() / 10
                )
            );
        }
    }
        ...
        if (hp != 0) {
            if (!skill) {
                ...
                hpchange +=
                    makeHealHP(
                        hp / 100.0,
                        applyfrom.getStat().getTotalMagic(),
                        3,
                        5
                    );
            }
            ...
            if (mpCon != 0) {
                ...
                if (isAFpMage || applyfrom.getJob().isA(PlayerJob.IL_MAGE)) {
                    ...
                    if (isAFpMage) {
                        amp =
                            PlayerSkillFactory.getSkill(
                                FPMage.ElementAmplification
                            );
                    } else {
                        amp =
                            PlayerSkillFactory.getSkill(
                                ILMage.ElementAmplification
                            );
                    }
    ...
    private int alchemistModifyVal(Player chr, int val, boolean withX) {
        if (
            !skill &&
            (
                chr.getJob().isA(PlayerJob.HERMIT) ||
                chr.getJob().isA(PlayerJob.NIGHTLORD)
            )
        ) {
            ...
            if (alchemistEffect != null) {
                return (int) (
                    ...
                    (
                        (
                            withX
                                ? alchemistEffect.getX()
                                : alchemistEffect.getY()
                        ) /
                        100.0
                    )
                );
    ...
    private boolean isPartyBuff() {
        ...
        if (
            (
                sourceid >= WhiteKnight.SwordFireCharge &&
                sourceid <= WhiteKnight.BwLitCharge
            ) ||
            sourceid == Paladin.SwordHolyCharge ||
            sourceid == Paladin.BwHolyCharge
        ) {
            return false;
        }
        return true;
    ...
    private boolean isSkillMorph() {
        return (
            skill &&
            (
                sourceid == Buccaneer.SuperTransformation ||
    ...
    public boolean isResurrection() {
        return (
            sourceid == SuperGm.Resurrection || sourceid == Bishop.Resurrection
        );
    }
    ...
    public boolean isMonsterRiding() {
        return (
            skill &&
            (
                sourceid == Beginner.MonsterRider ||
                sourceid == Corsair.Battleship
            )
        );
    }
    ...
    public boolean isPoison() {
        return (
            skill &&
            (
                sourceid == FPMage.PoisonMist ||
                sourceid == FPWizard.PoisonBreath ||
                sourceid == FPMage.ElementComposition
            )
        );
    }
    ...
    private boolean isMist() {
        return (
            skill &&
            (sourceid == FPMage.PoisonMist || sourceid == Shadower.Smokescreen)
        );
    }
    ...
    private boolean isSoulArrow() {
        return (
            skill &&
            (sourceid == Hunter.SoulArrow || sourceid == Crossbowman.SoulArrow)
        );
    }
    ...
    private boolean isDispel() {
        return (
            skill &&
            (sourceid == Priest.Dispel || sourceid == SuperGm.HealnDispel)
        );
    }
    ...
    private boolean isHeroWill() {
        return (
            skill &&
            (
                sourceid == Hero.HerosWill ||
                sourceid == Paladin.HerosWill ||
                sourceid == DarkKnight.HerosWill ||
                sourceid == FPArchMage.HerosWill ||
                sourceid == ILArchMage.HerosWill ||
                sourceid == Bishop.HerosWill ||
                sourceid == Bowmaster.HerosWill ||
                sourceid == Marksman.HerosWill ||
                sourceid == NightLord.HerosWill ||
                sourceid == Shadower.HerosWill ||
                sourceid == Buccaneer.PiratesRage ||
                sourceid == Corsair.HerosWill
            )
        );
    }
    ...
    public boolean hasNoIcon() {
        return (
            sourceid == 3111002 ||
            sourceid == 3211002 ||
            +sourceid == // puppet, puppet
            3211005 ||
            +sourceid == // golden eagle
            2121005 ||
            sourceid == 2221005 ||
            +sourceid == // elquines, ifrit
            2321003 ||
            sourceid == 3121006 ||
            +sourceid == // bahamut, phoenix
            3221005 ||
            sourceid == 3111005 ||
            +sourceid == // frostprey, silver hawk
            2311006 ||
            sourceid == 5220002 ||
            +sourceid == // summon dragon, wrath of the octopi
            5211001 ||
            sourceid == 5211002
        ); // octopus, gaviota
    }
    ...
    private boolean isCrash() {
        return (
            skill &&
            (
                sourceid == DragonKnight.PowerCrash ||
                sourceid == WhiteKnight.MagicCrash
            )
        );
    }
    ...
    public final void applyEnergyBuff(
        final Player applyto,
        int skillId,
        ...
        final ScheduledFuture<?> schedule = SkillTimer
            .getInstance()
            .schedule(
                cancelAction,
        ...
        this.statups =
            Collections.singletonList(
                new Pair<BuffStat, Integer>(BuffStat.ENERGY_CHARGE, 10000)
            );
        applyto.registerEffect(this, starttime, schedule);
        this.statups = stat;
    }
