...
public class MapleLifeFactory {
    ...
    private static final MapleDataProvider data = MapleDataProviderFactory.getDataProvider(
        new File(System.getProperty("wzpath") + "/Mob")
    );
    private static final MapleDataProvider dataNPC = MapleDataProviderFactory.getDataProvider(
        new File(System.getProperty("wzpath") + "/Npc")
    );
    ...
    private static final MapleDataProvider etcDataWZ = MapleDataProviderFactory.getDataProvider(
        new File(System.getProperty("wzpath") + "/Etc")
    );
    private static final MapleData mobStringData = stringDataWZ.getData(
        "Mob.img"
    );
    private static final MapleData npcStringData = stringDataWZ.getData(
        "Npc.img"
    );
    private static final MapleData npcLocationData = etcDataWZ.getData(
        "NpcLocation.img"
    );
    ...
    public static MapleMonsterStats getMonsterStats(int mid) {
        try {
            ...
            if (stats == null) {
                MapleData monsterData = data.getData(
                ...
                stats.setMp(
                    MapleDataTool.getIntConvert("maxMP", monsterInfoData, 0)
                );
                stats.setFriendly(
                ...
                stats.setUndead(
                    MapleDataTool.getIntConvert("undead", monsterInfoData, 0) >
                    0
                );
                stats.setName(
                ...
                stats.setBuffToGive(
                    MapleDataTool.getIntConvert("buff", monsterInfoData, -1)
                );
                stats.setCp(
                    MapleDataTool.getIntConvert("getCP", monsterInfoData, 0)
                );
                stats.setExplosive(
                    MapleDataTool.getIntConvert(
                        "explosiveReward",
                ...
                stats.setAccuracy(
                    MapleDataTool.getIntConvert("acc", monsterInfoData, 0)
                );
                MapleData firstAttackData = monsterInfoData.getChildByPath(
                    "firstAttack"
                );
                int firstAttack = 0;
                        ...
                        stats.addLoseItem(
                            new LoseItem(
                                MapleDataTool.getInt(
                                    liData.getChildByPath("id")
                                ),
                                (byte) MapleDataTool.getInt(
                                    liData.getChildByPath("prop")
                                ),
                                (byte) MapleDataTool.getInt(
                                    liData.getChildByPath("x")
                                )
                            )
                        );
                    }
                ...
                final MapleData reviveInfo = monsterInfoData.getChildByPath(
                    "revive"
                );
                if (reviveInfo != null) {
                ...
                decodeElementalString(
                    stats,
                    MapleDataTool.getString("elemAttr", monsterInfoData, "")
                );

                final int link = MapleDataTool.getIntConvert(
                    "link",
                    monsterInfoData,
                    0
                );
                ...
                final MapleData monsterSkillData = monsterInfoData.getChildByPath(
                    "skill"
                );
                if (monsterSkillData != null) {
                    ...
                    while (
                        monsterSkillData.getChildByPath(Integer.toString(i)) !=
                        null
                    ) {
                        skills.add(
                            new Pair<>(
    ...
    public static final void decodeElementalString(
    ...
    public static MapleNPC getNPC(int nid) {
        ...
        MapleData npcImgData = dataNPC.getData(
            StringUtil.getLeftPaddedStr(Integer.toString(nid), '0', 7) + ".img"
        );
        if (npcImgData == null) {
            return null;
        }
        ...
        if (npcInfoData != null) {
            int depositCost = MapleDataTool.getIntConvert(
                "trunkPut",
                npcInfoData,
                0
            );
            ...
            int withdrawCost = MapleDataTool.getIntConvert(
                "trunkGet",
                npcInfoData,
                0
            );
        ...
        MapleData npcLocationInfoData = npcLocationData.getChildByPath(
