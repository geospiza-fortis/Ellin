 ...
 * @author Tyler (Twdtwd)
 */
public final class MobRequirement extends MapleQuestRequirement {
    ...
    public void processData(MapleData data) {
        for (MapleData questEntry : data.getChildren()) {
            ...
            int countReq = MapleDataTool.getInt(
                questEntry.getChildByPath("count")
            );
    ...
    @Override
    public boolean check(Player p, Integer npcid) {
