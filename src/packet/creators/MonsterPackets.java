...
public class MonsterPackets {
    ...
    public static OutPacket ShowBossHP(
        int oid,
        int currHP,
        int maxHP,
        byte tagColor,
    ...
    public static OutPacket MoveMonster(
        int usesSkill,
        int skill,
        int skill_1,
        int skill_2,
     ...
     * @return The spawn monster packet.
     */
    public static OutPacket SpawnMonster(
        MapleMonster life,
        boolean newSpawn,
        int effect
    ) {
     ...
     */
    public static OutPacket ControlMonster(
        MapleMonster life,
        boolean newSpawn,
        boolean aggro
    ) {
     ...
     */
    private static OutPacket SpawnMonsterInternal(
     ...
     */
    public static OutPacket MoveMonsterResponse(
        int objectID,
        short moveID,
        int currentMP,
        boolean useSkills
    ) {
        return MoveMonsterResponse(
            objectID,
            moveID,
            currentMP,
            useSkills,
    ...
    public static OutPacket ApplyMonsterStatus(
        int objectID,
    ...
    public static OutPacket ApplyMonsterStatus(
        ...
        for (Map.Entry<MonsterStatus, Integer> stat : mse
            .getStati()
            .entrySet()) {
    ...
    public static OutPacket MobDamageMob(
        MapleMonster monster,
        int damage,
        boolean byMob
    ) {
    ...
    private static void WriteIntMask(
        WritingPacket wp,
        Map<MonsterStatus, Integer> stats
    ) {
        int firstMask = 0;
