...
public class ItemConstants {
    ...
    public static final int[] OWL_DATA = new int[] {
        1082002,
        2070005,
        2070006,
        1022047,
    ...
    public static final int[] CARDS_4HRS = { 5211048, 5360042 };
    ...
    public static final byte TOP = -5, BOTTOM = -6, SHOES = -7, SHIELD =
        -10, WEAPON = -11, MOUNT = -18;

    public static int[] CHARM_ITEM = { 5130000, 4031283, 4140903 };
    ...
    public static boolean isEffectRing(int itemid) {
        return (
            isFriendshipRing(itemid) ||
            isCrushRing(itemid) ||
            isWeddingRing(itemid)
        );
    }
    ...
    public static boolean canEquip(PlayerSkill skill, Client c) {
        return (
            SkillConstants.isBeginnerSkill(skill.getId()) ||
            !SkillConstants.isCorrectJobForSkillRoot(
    ...
    public static boolean haveSpace(final Player p, final List<Item> items) {
        ...
        return !(
            p.getInventory(InventoryType.EQUIP).getNumFreeSlot() < eq ||
            p.getInventory(InventoryType.USE).getNumFreeSlot() < use ||
            p.getInventory(InventoryType.SETUP).getNumFreeSlot() < setup ||
            p.getInventory(InventoryType.ETC).getNumFreeSlot() < etc ||
            p.getInventory(InventoryType.CASH).getNumFreeSlot() < cash
        );
    }
}
