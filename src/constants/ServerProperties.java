    ...
    public static final class Login {
        ...
        static {
            ...
            try {
                ...
                RANKING_INTERVAL =
                    Integer.parseInt(p.getProperty("LoginRankingInterval"));

                ENABLE_PIN =
                    Boolean.parseBoolean(p.getProperty("LoginEnablePin"));
                ENABLE_BALLONS =
                    Boolean.parseBoolean(p.getProperty("LoginEnableBallons"));
    ...
    public static final class World {
        ...
        static {
            ...
            try {
                ...
                MOUNT_EXP =
                    Integer.parseInt(p.getProperty("GameTamingMobRate"));
    ...
    public static final class Misc {
        ...
        static {
            ...
            try {
                ...
                VOTE_MESSAGE =
                    p.getProperty("ShowVoteMessage").equalsIgnoreCase("True");
                WELCOME_MESSAGE =
                    p
                        .getProperty("ShowWelcomeMessage")
