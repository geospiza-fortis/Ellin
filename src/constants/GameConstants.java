...
public class GameConstants {
    ...
    private static final NumberFormat nfFormatter = new DecimalFormat(
        "#,###,###,###"
    );
    private static final NumberFormat nfParser = NumberFormat.getInstance(
        USE_UNITPRICE_WITH_COMMA ? Locale.FRANCE : Locale.UK
    );
    //Event End Timestamp
    ...
    public static final String REACHED_MAX_LEVEL =
        "[Congrats] %s has reached Level 200! Let us congratulate %s on such an amazing achievement!";
    ...
    public static synchronized String numberWithCommas(int i) {
