...
public class MessengerService {
    ...
    public static MapleMessenger createMessenger(
        MapleMessengerCharacter chrfor
    ) {
            ...
            if (p != null) {
                ...
                if (messenger != null) {
                    p
                        .getClient()
                        .getSession()
                        .write(PacketCreator.MessengerNote(namefrom, 5, 0));
                }
            }
        }
    }
    ...
    public static void leaveMessenger(
        int messengerid,
                    ...
                    if (ch > 0) {
                        ...
                        if (chr != null) {
                            chr
                                ...
                                .getSession()
                                .write(
                                    PacketCreator.RemoveMessengerPlayer(
                                        position
                                    )
                                );
                        }
    ...
    public static void silentLeaveMessenger(
        int messengerid,
        MapleMessengerCharacter target
    ) {
        MapleMessenger messenger = getMessenger(messengerid);
    ...
    public static void silentJoinMessenger(
        int messengerid,
        MapleMessengerCharacter target
    ) {
        MapleMessenger messenger = getMessenger(messengerid);
            ...
            .forEachOrdered(
                messengerchar -> {
                    ...
                    if (ch > 0) {
                        ...
                        if (chr != null) {
                            Player from = ChannelServer
                                .getInstance(fromchannel)
                                .getPlayerStorage()
                            ...
                            chr
                                ...
                                .getSession()
                                .write(
                                    PacketCreator.UpdateMessengerPlayer(
                                        namefrom,
                                        from,
                                        position,
                                        fromchannel - 1
    ...
    public static void joinMessenger(
        ...
        messenger
            .getMembers()
            .stream()
            .filter(messengerchar -> (messengerchar != null))
            .forEachOrdered(
                messengerchar -> {
                    int mposition = messenger.getPositionByName(
                        messengerchar.getName()
                    );
                    int ch = FindService.findChannel(messengerchar.getName());
                    if (ch > 0) {
                        ...
                        if (p != null) {
                            if (!messengerchar.getName().equals(from)) {
                                ...
                                p
                                    ...
                                    .getSession()
                                    .write(
                                        PacketCreator.AddMessengerPlayer(
                                            from,
                                            fromCh,
                                            position,
                                            fromchannel - 1
                                ...
                                p
                                    ...
                                    .getSession()
                                    .write(
                                        PacketCreator.JoinMessenger(mposition)
                                    );
                            }
                        }
                    }
    ...
    public static void messengerChat(
        int messengerId,
        String chatText,
        String nameFrom
    ) {
            ...
            .forEach(
                messengerchar -> {
                    if (
                        ...
                        int ch = FindService.findChannel(
                            messengerchar.getName()
                        );
                        if (ch > 0) {
                            Player p = ChannelServer
                            ...
                            if (p != null) {
                                p
                                    ...
                                    .getSession()
                                    .write(
                                        PacketCreator.MessengerChat(chatText)
                                    );
                            }
                        }
                ...
                if (targeter != null && targeter.getMessenger() == null) {
                    if (!targeter.isGameMaster() || gm) {
                        ...
                        from
                            .getClient()
                            .getSession()
                            .write(PacketCreator.MessengerNote(target, 4, 1));
                    } else {
                        from
                            .getClient()
                            .getSession()
                            .write(PacketCreator.MessengerNote(target, 4, 0));
                    }
                } else {
                    from
                        .getClient()
