...
public class MovementParse {
    ...
    public static final List<LifeMovementFragment> parseMovement(
        ...
        for (int i = 0; i < numCommands; i++) {
            ...
            switch (command) {
                ...
                case WINGS_FALL:
                    {
                        ...
                        AbsoluteLifeMovement alm = new AbsoluteLifeMovement(
                            command,
                            pos,
                            duration,
                            newstate
                ...
                case WINGS:
                    {
                        ...
                        final int newstate = packet.readByte();
                        final int duration = packet.readShort();
                        RelativeLifeMovement rlm = new RelativeLifeMovement(
                            command,
                            pos,
                            duration,
                            newstate
                ...
                case UNK:
                    {
                        ...
                        TeleportMovement tm = new TeleportMovement(
                            command,
                            pos,
                            newstate
                        );
                ...
                case EQUIP_M:
                    {
                        res.add(
                            new ChangeEquipSpecialAwesome(packet.readByte())
                        );
                        break;
                    }
                case CHAIR:
                    {
                        ...
                        final int newstate = packet.readByte();
                        final int duration = packet.readShort();
                        ChairMovement cm = new ChairMovement(
                            command,
                            pos,
                            duration,
                            newstate
                ...
                case JUMP_DOWN:
                    {
                        ...
                        final int newstate = packet.readByte();
                        final int duration = packet.readShort();
                        JumpDownMovement jdm = new JumpDownMovement(
                            command,
                            pos,
                            duration,
                            newstate
    ...
    public static void updatePosition(
        ...
        final AnimatedMapleFieldObject target,
        final int yoffset
    ) {
        if (movement == null) {
            return;
