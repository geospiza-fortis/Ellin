...
public class ChatHandler {
    ...
    public static void GeneralChat(PacketReader packet, Client c) {
        ...
        if (
            ...
            if (
                ...
                p.dropMessage(
                    "GM has now silenced this map. Wait until it is activated again."
                );
            } else {
                if (!p.isHidden()) {
                    p
            ...
            case COMMAND_FIND:
                {
                    ...
                    if (victim != null) {
                        if (
                            ...
                            if (victim.getCashShop().isOpened()) {
                                c
                                    .getSession()
                                    .write(
                                        PacketCreator.GetFindReplyWithCS(
                                            victim.getName()
                                        )
                                    );
                            } else if (
                                ...
                                c
                                    .getSession()
                                    .write(
                                        PacketCreator.GetFindReplyWithMap(
                                            victim.getName(),
                                            victim.getMapId()
                                        )
                                    );
                        ...
                        c
                            .getSession()
                            .write(
                                PacketCreator.GetWhisperReply(toFind, (byte) 0)
                            );
                    }
                    break;
                }
    ...
    public static void Messenger(PacketReader packet, Client c) {
        ...
        switch (packet.readByte()) {
                ...
                if (messenger == null) {
                    ...
                    if (messengerid == 0) {
                        c
                            .getPlayer()
                            .setMessenger(
                                MessengerService.createMessenger(
                        ...
                        if (messenger != null) {
                            ...
                            if (position > -1 && position < 4) {
                                ...
                                MessengerService.joinMessenger(
                                    messenger.getId(),
                                    new MapleMessengerCharacter(c.getPlayer()),
                                    c.getPlayer().getName(),
                                    c.getChannel()
                ...
                if (messenger != null) {
                    ...
                    if (target != null) {
                        if (target.getMessenger() == null) {
                            if (
                                ...
                                c
                                    .getSession()
                                    .write(
                                        PacketCreator.MessengerNote(input, 4, 1)
                                    );
                                target
                                    .getClient()
                                    .getSession()
                                    .write(
                                        PacketCreator.MessengerInvite(
                                            c.getPlayer().getName(),
                                            messenger.getId()
                                        )
                                    );
                                ...
                                c
                                    .getSession()
                                    .write(
                                        PacketCreator.MessengerNote(input, 4, 0)
                                    );
                            }
                        } else {
                            c
                        ...
                        if (World.isConnected(input)) {
                            MessengerService.messengerInvite(
                                c.getPlayer().getName(),
                                messenger.getId(),
                                input,
                                c.getChannel(),
            ...
            case MESSENGER_CHAT:
                if (messenger != null) {
                    MessengerService.messengerChat(
                        messenger.getId(),
    ...
    public static void Spouse_Chat(PacketReader packet, Client c) {
        ...
        if (
            c.getPlayer().getPartnerId() == 0 ||
            !c.getPlayer().getPartner().equalsIgnoreCase(recipient)
        ) {
            c
                .getPlayer()
                .dropMessage(
                    5,
                    "You are not married or your spouse is offline."
                );
            c.announce(PacketCreator.EnableActions());
            return;
        }
        if (channel > 0) {
            Player spouseChar = ChannelServer
                .getInstance(channel)
                .getPlayerStorage()
                .getCharacterByName(recipient);
            if (spouseChar == null) {
