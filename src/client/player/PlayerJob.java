...
public enum PlayerJob {
    ...
    public static final int CLASS_BEGINNER = 0, CLASS_WARRIOR =
        1, CLASS_MAGICIAN = 2, CLASS_BOWMAN = 3, CLASS_THIEF = 4, CLASS_PIRATE =
        5, CLASS_GAMEMASTER = 9;
    ...
    public boolean isA(PlayerJob basejob) {
        return (
            getId() >= basejob.getId() && getId() / 100 == basejob.getId() / 100
        );
    }
