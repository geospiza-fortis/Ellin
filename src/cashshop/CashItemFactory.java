        ...
        etc
            ...
            .forEach(
                item -> {
                    ...
                    short count = (short) MapleDataTool.getIntConvert(
                        "Count",
                        item,
                        1
                    );
                    boolean onSale =
                        MapleDataTool.getIntConvert("OnSale", item, 0) == 1;
                    items.put(
                        sn,
                        new CashItem(
                            sn,
                ...
                cashPackage -> {
                    ...
                    cashPackage
                        ...
                        .forEach(
                            item -> {
                                cPackage.add(
                                    Integer.parseInt(item.getData().toString())
                                );
                            }
                        );

                    packages.put(
                        Integer.parseInt(cashPackage.getName()),
                        cPackage
                    );
                }
            );
            ...
            .forEach(
                sn -> {
                    cashPackage.add(
                        getItem(sn)
                            .toItem(
                                CashItemFactory.getItem(sn),
                                CashItemFactory.getItem(sn).getCount()
                            )
                    );
                }
            );
