...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            cm.sendSimple(
                "I'm the head of this hair salon. If you have a #b#t5150027##k or a #b#t5151022##k allow me to take care of your hairdo. Please choose the one you want.\r\n#L0##i5150027##t5151022##l\r\n#L1##i5150026##t5150026##l"
            );
        } else if (status == 1) {
            if (selection == 0) {
                beauty = 1;
                ...
                cm.sendStyle(
                    "I can totally change up your hairstyle and make it look so good. Why don't you change it up a bit? If you have #b#t5150027##k I'll change it for you. Choose the one to your liking~.",
                    hairnew
                );
            } else if (selection == 1) {
                beauty = 2;
                ...
                cm.sendStyle(
                    "I can totally change your haircolor and make it look so good. Why don't you change it up a bit? With #b#t5151022##k I'll change it for you. Choose the one to your liking.",
                    haircolor
                );
            }
        } else if (status == 2) {
