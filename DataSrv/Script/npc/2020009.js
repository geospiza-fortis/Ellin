...
function start() {
    if (
        !(cm.getPlayer().getLevel() >= 70 && parseInt(cm.getJobId() / 100) == 2)
    ) {
...
function action(mode, type, selection) {
    ...
    if (actionx["Mental"]) {
        ...
        cm.sendNext(
            "Go, talk with #b#p1032001##k and bring me #b#t4031057##k."
        );
        cm.dispose();
