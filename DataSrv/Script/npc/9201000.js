...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            if (
                cm.getPlayer().getMarriageQuestLevel() == 0 &&
                cm.getPlayer().getLevel() >= 10
            ) {
                cm.sendNext(
                    "Hey, I'm Moony, and I make engagement rings for marriage."
                );
                ...
                if (numberOfLoves >= 4) {
                    cm.sendNext(
                        "Wow, your'e back pretty early. Got the #bProof of Loves#k? Lets see..."
                    );
                } else {
                    cm.sendOk(
                        "Please come back when you got 4 different #bProof of Loves#k."
                    );
                    cm.dispose();
                }
            } else if (cm.getPlayer().getMarriageQuestLevel() == 2) {
                cm.sendSimple(
                    "Hey, your'e back! Ready to choose your ring?\r\n#b#L0#Moonstone Ring#l\r\n#L1#Star Gem Ring#l\r\n#L2#Golden Heart Ring#l\r\n#L3#Silver Swan Ring#l#k"
                );
            } else {
            ...
            if (
                ...
                cm.sendYesNo(
                    "Hey, you look like you might want to be married! Want to make an engagement ring?"
                );
            } else if (cm.getPlayer().getMarriageQuestLevel() == 1) {
                cm.sendNext(
                    "Great work getting the #bProof of Loves#k! Now we can make the #bEngagement Ring#k."
                );
            } else if (cm.getPlayer().getMarriageQuestLevel() == 2) {
                ringSelection = selection;
                if (ringSelection == 0) {
                    if (
                        cm.haveItem(4011007, 1) &&
                        cm.haveItem(4021007, 1) &&
                        cm.getPlayer().getMeso() >= 3000000
                    ) {
                    ...
                    if (
                        ...
                        cm.haveItem(4021007, 1) &&
                        cm.getPlayer().getPlayer().getMeso() >= 1000000
                    ) {
            ...
            if (
                ...
                cm.getPlayer().addMarriageQuestLevel();
                cm.sendOk(
                    "Okay, first bring me back any four colored #bProof of Loves#k. You can get them from talking to #bNana the Love Fairy#k in any town. Also, only one of you, either the Groom or Bride will do this quest."
                );
                cm.dispose();
            } else if (cm.getPlayer().getMarriageQuestLevel() == 1) {
                ...
                cm.getPlayer().addMarriageQuestLevel();
                cm.sendNextPrev(
                    "You need the following raw materials to make an\r\n#bEngagement Ring#k.\r\n\r\n#e#dMoonstone Ring:#k\r\n#v4011007#Moon Rock 1,#v4021007#Diamond 1, 3,000,000 Meso\r\n#dStar Gem Ring:#k\r\n#v4021009#Star Rock 1,#v4021007#Diamond 1, 2,000,000 Meso\r\n#dGolden Heart Ring:#k\r\n#v4011006#Gold Plate 1,#v4021007#Diamond 1, 1,000,000 Meso\r\n#dSilver Swan Ring:#k\r\n#v4011004#Silver Plate 1,#v4021007#Diamond 1, 500,000 Meso\r\n"
                );
                cm.dispose();
            }
        }
