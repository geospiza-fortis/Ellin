        ...
        if (eim.getProperty(stage.toString() + "stageclear") != null) {
            ...
            if (eim.isEventLeader(cm.getPlayer())) {
                ...
                if (state == -1) {
                    // preamble
                    cm.sendOk(
                        "Hi. Welcome to the #bBOSS stage#k. Kill the Ratz on that platform to reveal the Alishar, and defeat him!"
                    );
                    ...
                    if (cm.haveItem(4001023, 1)) {
                        ...
                        cm.sendNext(
                            "Please defeat Alishar and bring me his #b#t4001023#.#k"
                        );
                    }
                }
            } else {
