...
var status = 0;
var mainmenu =
    "Aqui voce pode me perguntar e tirar qualquer duvida sobre viajar.\r\n#L0##bComo faco para me locomover?#l\r\n#L1#Como faco para matar os monstros?#l\r\n#L2#Como posso pegar um item?#l\r\n#L3#O que acontece quando eu morrer?#l\r\n#L4#Quando posso escolher um emprego?#l\r\n#L5#Diga-me mais sobre esta ilha!#l\r\n#L6#O que devo fazer para se tornar um guerreiro?#l\r\n#L7#O que devo fazer para se tornar um Arqueiro?#l\r\n#L8#O que devo fazer para se tornar um Mago?#l\r\n#L9#O que devo fazer para se tornar um Gatuno?#l\r\n#L10#Como faco para aumentar as estatisticas do personagem? (S)#l\r\n#L11#Como posso verificar os itens que eu peguei?#l\r\n#L12#Como faco para colocar um item?#l\r\n#L13#Como posso verificar os itens que estou usando?#l\r\n#L14#O que sao skills? (K)#l\r\n#L15#Como faco para chegar a Ilha Victoria?#l\r\n#L16#Oque sao mesos?#l#k";
    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                // How do I raise the character stats? (S)
                status = 22;
                cm.sendNext(
