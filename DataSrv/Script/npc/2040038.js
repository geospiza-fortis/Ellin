                ...
                if (state == -1) {
                    ...
                    cm.sendOk(
                        "Hi. Welcome to the #bstage " +
                            stage +
                            "#k. Collect 32 #t4001022#'s scattered across the map, then talk to me."
                    );
                    ...
                    if (cm.haveItem(4001022, 32)) {
                        cm.sendOk(
                            "Good job! You have collected all 32 #b#t4001022#'s.#k"
                        );
                        ...
                        cm.sendNext(
                            "Sorry you don't have all 32 #b#t4001022#'s.#k"
                        );
                    }
                }
            } else {
