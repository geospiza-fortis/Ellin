        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                if (cm.getParty() == null) {
                    ...
                    if (party.size() == 2) {
                        if (party.get(0).getGender() == 0) {
                                        ...
                                        if (
                                            ...
                                            if (em == null) {
                                                ...
                                                var StringLine =
                                                    ...
                                                    " & " +
                                                    wname +
                                                    "] Ir�o se casar na Catedral, no canal (" +
                                                    cm
                                                        .getClient()
                                                        .getChannel() +
                                                    ").";
                                            ...
                                            cm.sendOk(
                                                "Voc� n�o tem os itens necess�rios, desculpe!"
                                            );
                                    } else cm.sendOk("Voc� j� est� casado.");
                                } else
                                    cm.sendOk(
                                        "O nosso servidor n�o suporta este tipo de casamento!"
                                    );
                            } else
                                cm.sendOk(
                                    "Voc�s precisam estar no mesmo mapa e ser pelo menos no n�vel [" +
                                        minLevel +
                                        " ~ " +
                                        maxLevel +
                                        "]"
                            ...
                            cm.sendOk(
                                "Por favor fa�a o teu marido lider do grupo."
                            );
                ...
                if (cm.haveItem(5251100, 1)) {
                    ...
                    cm.sendOk(
                        "Parece que o casal que voc� quer assistir n�o te deu um convite ainda."
                    );
                    cm.dispose();
                }
            } else if (selection == 2) {
                ...
                cm.sendOk(
                    "Voc� pode comprar um Bilhete de Casamento com a Ria! Localizada no Mercado Livre."
                );
                ...
                if (cm.getPlayer().getMarriageQuestLevel() == 50) {
                    cm.sendNext(
                        "Por favor, v� visitar a Mom eo Dad em sua casa. Eles vivem em algum lugar Henesys Hunting Ground II."
                    );
            ...
            if (chr != null) {
                if (chr.getMapId() == 680000200) {
                    ...
                    cm.sendOk(
                        "O casamento que voc� gostaria de participar n�o foi iniciado."
                    );
                }
            } else cm.sendOk("Jogador n�o encontrado.");
            cm.dispose();
        }
        ...
        if (husband != null && wife != null) {
            if (status == 0) {
                if (id != husband.getId() && id != husband.getId()) {
                    ...
                    cm.sendOk(
                        "Voc� j� aceitou casar-se com sua esposa, pergunte � sua esposa a aceitar agora"
                    );
                    cm.dispose();
                } else if (
                    wclicked == 1 &&
                    ...
                    cm.sendOk(
                        "Voc� j� aceitou casar-se com o seu marido , pergunte ao seu marido a aceitar agora"
                    );
                    cm.dispose();
                } else {
                    cm.sendYesNo(
                        "Voc� deseja se casar com seu parceiro?\r\n\r\nIsso ser� uma decis�o final."
                    );
                }
            } else if (status == 1) {
                ...
                if (
                    ...
                    if (!cm.createMarriage(otherChar.getName())) {
                        cm.sendOk(
                            "O sistema n�o pode encontrar o seu parceiro."
                        );
                        cm.dispose();
                        return;
                    }
                    cm.worldMessage(
                        ...
                        "Parab�ns a " +
                            ...
                            " e " +
                            wifeName +
                            ". S�o rec�m-casados, voc� pode ench�-los de spam agora!"
                    );
