                ...
                if (state == -1) {
                    ...
                    cm.sendOk(
                        "Hi. Welcome to the #bstage " +
                            stage +
                            "#k. You need ranged personnel here. They must kill the three Ratz, which will trigger something. What's next is for you to find out! Get me 3 passes!"
                    );
                    ...
                    if (cm.haveItem(4001022, 3)) {
                        cm.sendOk(
                            "Good job! You have collected all 3 #b#t4001022#'s.#k"
                        );
                        ...
                        cm.sendNext(
                            "Sorry you don't have all 3 #b#t4001022#'s.#k"
                        );
                    }
                }
            } else {
