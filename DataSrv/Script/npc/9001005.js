    ...
    if (mode == -1) cm.dispose();
        ...
        if (status == 0) {
            if (cm.getPlayer().getGender() == 1) {
                cm.sendOk("Voc� deve falar com o NPC do seu genero.");
                cm.dispose();
            } else {
                cm.sendSimple(
                    "Neste NPC e possivel trocar seu visual usando JS-Points, est� interessado?\r\nLembrando que cada modfica��o e (#e10#n) JS-Points.\r\n#L0#Cor#l\r\n#L1#Cabelo#l\r\n#L2#Cor do Cabelo#l\r\n#L3#Olhos#l\r\n#L4#Cor dos Olhos#l"
                );
            }
        } else if (status == 1) {
            if (selection == 0) {
                ...
                for (var i = 0; i < hair.length; i++) {
                    if (hair[i] == 30100 || hair[i] == 30010)
                        ...
                        hairnew.push(
                            hair[i] + parseInt(cm.getPlayer().getHair() % 10)
                        );
                }
                ...
                else if (current == 30010) haircolor = Array(current);
                else {
                    for (var i = 0; i < 8; i++) haircolor.push(current + i);
                }
            ...
            if (cm.getPlayer().getCSPoints(2) >= 10) {
                ...
                cm.sendOk("Voc� n�o tem JS-Points, me desculpe.");
                cm.dispose();
            }
        }
    }
