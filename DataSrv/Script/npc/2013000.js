    ...
    if (mode == -1) {
        ...
        if (cm.getMapId() == 200080101) {
            if (status == 0) {
                ...
                cm.sendSimple(
                    "#e#b<Party Quest: Tower of Goddess>\r\n#k#n" +
                ...
                if (selection == 0) {
                    if (!cm.haveItem(1082232) && cm.haveItem(4001158, 10)) {
                        ...
                        cm.sendOk(
                            "You either have Goddess Wristband already or you do not have 10 #t4001158#."
                        );
                        cm.dispose();
                    }
                }
            ...
            if (status == 0) {
                cm.sendYesNo(
                    "Are you going to drop out from this rescue mission?"
                );
            } else if (status == 1) {
                cm.warp(920011200);
                cm.dispose();
