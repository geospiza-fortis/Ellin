                ...
                if (state == -1) {
                    ...
                    cm.sendOk(
                        "Hi. Welcome to the #bstage " +
                            stage +
                            "#k. Collect 25 #t4001022#'s scattered across the map, then talk to me."
                    );
                    ...
                    if (cm.haveItem(4001022, 25)) {
                        cm.sendOk(
                            "Good job! You have collected all 25 #b#t4001022#'s.#k"
                        );
                        ...
                        cm.sendNext(
                            "Sorry you don't have all 25 #b#t4001022#'s.#k"
                        );
                    }
                }
            } else {
