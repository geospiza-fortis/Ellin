...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            cm.sendSimple(
                "I'm Midori, Tepei's assistant. If you have a #b#t5150008##k or a #b#t5151008##k, please let me change your hairdo!\r\n#L0##i5150008##t5150008##l\r\n#L1##i5151008##t5151008##l"
            );
        } else if (status == 1) {
            if (selection == 0) {
                beauty = 1;
                ...
                cm.sendYesNo(
                    "If you use the EXP coupon your hair will change RANDOMLY with a chance to obtain a new experimental style that I came up with. Are you going to use #b#t5150011##k and really change your hairstyle?"
                );
            } else if (selection == 1) {
                beauty = 2;
                haircolor = Array();
