...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        options = [
            "#L1#Leave the room #r#e(WARNING: Abusing this will block you from future Carnival PQs)#b#n.#l",
            "#L2#Close NPC#l",
        ];
        if (cm.isLeader()) {
        ...
        text =
            "Welcome to Carnival PQ. I am #bAssistant Blue#k. What can I do for you?#b\r\n";
