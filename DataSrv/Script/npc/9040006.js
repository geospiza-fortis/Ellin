    ...
    if (eim == null) {
        ...
        if (cm.isEventLeader()) {
            ...
            if (currentCombo == null || currentCombo.equals("reset")) {
                ...
                cm.sendOk(
                    "This fountain guards the secret passage to the throne room. Offer items in the area to the vassals to proceed. The vassals shall tell you whether your offerings are accepted, and if not, which vassals are displeased. You have seven attempts. Good luck."
                );
            } else {
                ...
                if (guess != null) {
                    if (combo == guess) {
                        ...
                        removeGroundItems();
                        cm.sendOk(
                            "Excellent work. You may proceed to the next stage."
                        );
                    } else {
                        if (attempt < 7) {
                            ...
                            if (correct != 0) {
                                if (correct == 1) {
                                    string +=
                                        "1 vassal is pleased with their offering.\r\n";
                                } else {
                                    string +=
                                        correct +
                            ...
                            if (incorrect != 0) {
                                if (incorrect == 1) {
                                    string +=
                                        "1 vassal has received an incorrect offering.\r\n";
                                } else {
                                    string +=
                                        incorrect +
                                        " vassals have received incorrect offerings.\r\n";
                                }
                            }
                            if (unknown != 0) {
                                if (unknown == 1) {
                                    string +=
                                        "1 vassal has received an unknown offering.\r\n";
                                } else {
                                    string +=
                                        unknown +
                                        " vassals have received unknown offerings.\r\n";
                                }
                            }
                            string += "This is your ";
                            switch (attempt) {
                            ...
                            cm.sendOk(
                                "You have failed the test. Please compose yourselves and try again later."
                            );
                    ...
                    cm.sendOk(
                        "Please make sure your attempt is properly set in front of the vassals and talk to me again."
                    );
                }
            }
        } else {
...
function getGroundItems() {
    ...
    for (var j = 0; j < rawItems.length; j++) {
        ...
        for (var i = 0; i < 4; i++) {
            if (
                cm.getPlayer().getMap().getArea(i).contains(item.getPosition())
            ) {
