        ...
        if (status == 1) {
            if (check != 1) {
                if (cm.getPlayer().getMeso() < 5000) {
                    cm.sendOk(
                        "Sorry but it doesn't like you have enough mesos!"
                    );
                    cm.dispose();
                } else {
                    if (cm.isQuestStarted(2050)) cm.warp(101000100, 0);
                    else if (cm.isQuestStarted(2051)) cm.warp(101000102, 0);
                    else if (cm.getLevel() >= 25 && cm.getLevel() < 50)
                        cm.warp(101000100, 0);
                    else if (cm.getLevel() >= 50) cm.warp(101000102, 0);
                    cm.gainMeso(-5000);
                    cm.dispose();
                }
            }
